...
export async function scrapeRedstoreCamera() {
  return fetchCategory("photo-and-video-recorders", normalize);
}

export const scrapeRedstoreCameras = scrapeRedstoreCamera;
