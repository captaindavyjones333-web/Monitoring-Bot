...
export const HEADPHONE_REGEX = /\bairpods\b|\bbuds\b|marshall\s*(major|minor|monitor|motif|heston)/i;
export const MACBOOK_REGEX = /\bmacbook\b/i;
export const SPEAKER_REGEX = /\bspeaker\b|\bharman\s*kardon\b|\bjbl\b|marshall\s*(emberton|acton|stanmore|middleton|stockwell|willen|woburn|tufton|kilburn)/i;
